...
describe('sitemapItem', () => {
  ...
  describe('video', () => {
    ...
    it('can render a complex config', () => {
    ...
    it('throws on invalid video price currency', () => {
      expect(function () {
        var smap = new SitemapItem({
          'url': 'https://roosterteeth.com/episode/achievement-hunter-achievement-hunter-burnout-paradise-millionaires-club',
          'video': [{
    ...
    it('throws on invalid video price resolution', () => {
      expect(function () {
        var smap = new SitemapItem({
          'url': 'https://roosterteeth.com/episode/achievement-hunter-achievement-hunter-burnout-paradise-millionaires-club',
          'video': [{
    ...
    it('throws on invalid video platform relationship', () => {
      expect(function () {
        var smap = new SitemapItem({
          'url': 'https://roosterteeth.com/episode/achievement-hunter-achievement-hunter-burnout-paradise-millionaires-club',
          // @ts-ignore
    ...
    it('throws on invalid video restriction', () => {
      expect(function () {
        var smap = new SitemapItem({
          'url': 'https://roosterteeth.com/episode/achievement-hunter-achievement-hunter-burnout-paradise-millionaires-club',
          'video': [{
    ...
    it('throws on too long of a description', () => {
      expect(function () {
        var smap = new SitemapItem({
          'url': 'https://roosterteeth.com/episode/achievement-hunter-achievement-hunter-burnout-paradise-millionaires-club',
          'video': [{
