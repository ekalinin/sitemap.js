  ...
  while ( ps-- ) {
    ...
    if(this[p] && p == 'img') {
      ...
      if(typeof(this[p])=='object'){
        if(typeof(this[p][0]) != 'undefined') {
          if(this[p]&&this[p].length>0){
            imagexml = '';
            this[p].forEach(function(image){
              imagexml += '<image:image><image:loc>'+image.url+'</image:loc><image:caption><![CDATA['+image.caption+']]></image:caption></image:image>';
            });
          }
        }
        else imagexml = '<image:image><image:loc>'+this[p].url+'</image:loc><image:caption><![CDATA['+this[p].caption+']]></image:caption></image:image>';
      }
